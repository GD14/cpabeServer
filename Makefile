...
OST_DIR = /usr/include/boost/
THRIFT_DIR = /usr/local/include/thrift
LIB_DIR = /usr/local/lib
CPABE_SRC=./gen-cpp/cpabe_types.cpp ./gen-cpp/cpabe_constants.cpp ./gen-cpp/Cpabe.cpp
...
#	$(CC) -o $@ $^ $(LDFLAGS)
cpabe-server:  mycpabe.o common.o policy_lang.o CpabeServer.o ./gen-cpp/cpabe_types.o ./gen-cpp/cpabe_constants.o ./gen-cpp/Cpabe.o
	g++ -o $@ $^ $(LDFLAGS)	-lthrift
CpabeServer.o: CpabeServer.cpp
	g++ -c -I${THRIFT_DIR} -I${BOOST_DIR}  -I./gen-cpp -L${LIB_DIR}  CpabeServer.cpp $(CFLAGS) -lthrift
